...
async function run() {
  try {
    ...
    app.get("/jobseekerapply", async (req, res) => {
      ...
      const cursor = applicationCollections
        .find(query)
    ...
    app.put("/employerupdate/:id", async (req, res) => {
      ...
      const result = await employerCollections.updateOne(
        filter,
        updatedData,
        options
      );
    ...
    app.post("/jobSeekersPersonal", async (req, res) => {
      ...
      const alreadySaved = await jobSeekersPersonalDetails
        .find(query)
        .toArray();
      ...
      const newData = {
        ...
        presentThana: savedData.presentThana,
        presentPostOffice: savedData.presentPostOffice,
        presentAddressLine2: savedData.presentAddressLine2,
        permanentDistrict: savedData.permanentDistrict,
        permanentThana: savedData.permanentThana,
        permanentPostOffice: savedData.permanentPostOffice,
        permanentAddressLine2: savedData.permanentAddressLine2,
        careerObjective: savedData.careerObjective,
        image: imageUrl,
      };
    ...
    app.put("/jobSeekersPersonal/:id", async (req, res) => {
      ...
      const result = await jobSeekersPersonalDetails.updateOne(
        filter,
        updatedData,
        options
      );
    ...
    app.put("/jobSeekersExperiences/:id", async (req, res) => {
      ...
      const result = await jobSeekersExperiences.updateOne(
        filter,
        updatedData,
        options
      );
    ...
    app.put("/jobseekersAcademics/:id", async (req, res) => {
      ...
      const result = await jobSeekersAcademics.updateOne(
        filter,
        updatedData,
        options
      );
    ...
    app.put("/jobseekersCareersSkill/:id", async (req, res) => {
      ...
      const result = await jobSeekersCareers.updateOne(
        filter,
        updatedData,
        options
      );
    ...
    app.put("/jobseekersLanguagesReferences/:id", async (req, res) => {
      ...
      const result = await jobSeekersReferences.updateOne(
        filter,
        updatedData,
        options
      );
    ...
    app.get("/jobSeekersAllData/:email", async (req, res) => {
      ...
      const jobSeekersData = await jobSeekersPersonalDetails
        .aggregate([
    ...
    app.post("/subscribers", async (req, res) => {
      ...
      const alreadySubscribed = await subscriberCollections
        .find(query)
        .toArray();
